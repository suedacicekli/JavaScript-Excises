...
//smile  için bootstrpten icon aldık. svg olarak buraya getiridk
...
// sad için bootstrpten icon aldık. svg olarak buraya getiridk
...
//koşullu geçen öğrenciler için emoji :/
const NEUTRAL = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-emoji-neutral" viewBox="0 0 16 16">
  <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
  <path d="M4 10.5a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 0-1h-7a.5.5 0 0 0-.5.5zm3-4C7 5.672 6.552 5 6 5s-1 .672-1 1.5S5.448 8 6 8s1-.672 1-1.5zm4 0c0-.828-.448-1.5-1-1.5s-1 .672-1 1.5S9.448 8 10 8s1-.672 1-1.5z"/>
</svg>`
// examGRade bilgisi 100 den büyük 1 den küçük olmamalıdır bu yüzden bunu sarmalamam gerekiyor.


let examGrade = prompt("Lütfen Sınav Puanınızı Giriniz !")
let textInfo;
let info = document.querySelector("#info")  // renkleri verebilmek için yukarı aldım

if (examGrade >= 0 && examGrade <= 100) {
    //tüm if blokları bunun içine gelir yani kapsayıcılık burada mevcuttur.
    textInfo = SMILE //smile için ekledik
    if (examGrade >= 90) {
    ...
    textInfo = "Bilgiler doğru değil.(0-100)"
}
// console.log(textInfo) // bu şekilde konsola yazdırırım


info.innerHTML = ` ${examGrade} : ${textInfo} ` //ekrana basacağımız bilgiyi belirttik
